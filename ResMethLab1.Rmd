...
```
Call:
glm(formula = cbind(ndetect, nNOdetect) ~ slope, family = binomial,
    data = data)
Deviance Residuals:
     Min        1Q    Median        3Q       Max
-1.08294  -0.81103   0.02806   0.66110   1.14596
Coefficients:
            Estimate Std. Error z value Pr(>|z|)
(Intercept)  -0.4109     0.4906  -0.837  0.40238
slope         1.9383     0.5398   3.591  0.00033 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
(Dispersion parameter for binomial family taken to be 1)
    Null deviance: 35.412  on 9  degrees of freedom
Residual deviance:  6.534  on 8  degrees of freedom
AIC: 19.733
...
Deviance Residuals:
     Min        1Q    Median        3Q       Max
-2.41700  -0.82552  -0.00656   0.59693   2.08337
Coefficients:
            Estimate Std. Error z value Pr(>|z|)
